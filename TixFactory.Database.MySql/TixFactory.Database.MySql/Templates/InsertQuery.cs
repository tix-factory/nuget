...
namespace TixFactory.Database.MySql.Templates
{
    ...
    internal partial class InsertQuery : InsertQueryBase
    {
#line hidden
        /// <summary>
 ...
 foreach (var column in Vars.Columns) { 
            ...
            #line 10 "E:\Git\tix-factory\nuget\TixFactory.Database.MySql\TixFactory.Database.MySql\Templates\InsertQuery.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(column == Vars.Columns.ElementAt(Vars.Columns.Count - 1) ? "" : ","));
 ...
 foreach (var column in Vars.Columns) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(column.InsertValue));
...
private global::TixFactory.Database.MySql.Templates.InsertQueryVariables _VarsField;

/// <summary>
/// Access the Vars parameter of the template.
/// </summary>
private global::TixFactory.Database.MySql.Templates.InsertQueryVariables Vars
{
    get
    {
...
{
    this._VarsField = ((global::TixFactory.Database.MySql.Templates.InsertQueryVariables)(this.Session["Vars"]));
...
if ((VarsValueAcquired == false))
{
    ...
    if ((data != null))
    {
        this._VarsField = ((global::TixFactory.Database.MySql.Templates.InsertQueryVariables)(data));
    }
}
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    internal class InsertQueryBase
    {
        #region Fields
