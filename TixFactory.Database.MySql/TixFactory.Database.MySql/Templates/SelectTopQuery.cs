...
private global::TixFactory.Database.MySql.SelectQueryVariables _VarsField;

/// <summary>
/// Access the Vars parameter of the template.
/// </summary>
private global::TixFactory.Database.MySql.SelectQueryVariables Vars
{
    get
    {
...
{
    this._VarsField = ((global::TixFactory.Database.MySql.SelectQueryVariables)(this.Session["Vars"]));
...
if ((VarsValueAcquired == false))
{
    ...
    if ((data != null))
    {
        this._VarsField = ((global::TixFactory.Database.MySql.SelectQueryVariables)(data));
    }
}
